...
#----
#
#  Run using command line: $build-python-cli.sh
#
#----
...
export PYTHON_CLI_BUILD_TEMP='/tmp/python-cli/build/'
...
cp -R $PYTHON_CLI_BUILD_TEMP/_build/html $DOC_BASE/python-cli/sphinx/

echo "Copied html site from _build/html to $DOC_BASE/python-cli/sphinx/"
